...
export default function ContactUs() {
  ...
  function handleWhatsApp() {
    ...
    const whatsappURL = `https://wa.me/4917682360647?text=${encodeURIComponent(
      text
    )}`;
